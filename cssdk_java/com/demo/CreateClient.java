...
public class CreateClient {
  ...
  public static void main(String[] args) {
   ...
   // read the factory type from a properties file
    ...
    // note that getClient takes username, role, password
    // in a different sequence than the command line
    // using null for the server reads the server name from defaultTSServer
    // in cssdk.cfg
